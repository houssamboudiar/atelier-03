...
(function () {
  ...
  var $ = {},
    ...
    ra = {
      ...
      ToolTip: {
        ...
        reversed: !1,
        backgroundColor: v ? "#F9FAFB" : "rgb(255,255,255)",
        borderColor: null,
        borderThickness: 21,
        cornerRadius: 10,
        fontSize: 14,
        fontColor: "black",
        fontFamily: "slabo, slabo, Calibri, Arial, Georgia, serif;",
        fontWeight: "normal",
        fontStyle: "italic",
        publicProperties: {
          options: "readWrite",
      ...
      Crosshair: {
        ...
        labelBorderThickness: 0,
        labelCornerRadius: 0,
        labelFontFamily: v ? "slabo, slabo, Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "slabo, Calibri",
        labelFontSize: 12,
        labelFontColor: "#fff",
        labelFontWeight: "normal",
        labelFontStyle: "normal",
    ...
    Aa = {
      colorSet1: "#2CC2A3 #C22C4B #5F79EC #00E2C4 #9332D3 #10DBFF #FF5900 #BB2DD2 #00B83F #054AB9 #FF4400".split(" "),
  ...
  var ba = 20,
    ...
    $a = {
      ...
      axisX: [{
        titleFontFamily: "slabo",
        titleFontSize: ba,
        titleFontColor: "#666666",
        titleFontWeight: "normal",
        labelFontFamily: "slabo",
        labelFontSize: z,
  ...
  La.Chart = function () {
    ...
    Z.prototype._initialize = function () {
      if (this.enabled) {
        ...
        a += "padding: 5px;";
        a += "font-family: slabo, Calibri, Arial, Georgia, serif;";
          ...
          if (b = "", b = this.getToolTipInnerHTML({
            ...
            try {
              this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor : v ? "rgba(255,255,255,.9)" : "rgb(255,255,255)", this.borderColor = "waterfall" === g[0].dataSeries.type ?
                ...
                this.cornerRadius || 0 === this.cornerRadius ? this.cornerRadius + "px" : "5px", this.container.style.borderRadius = this.contentDiv.style.borderRadius, this.contentDiv.style.fontSize = this.fontSize || 0 === this.fontSize ? this.fontSize + "px" : "14px", this.contentDiv.style.color = this.fontColor ? this.fontColor : "#000000", this.contentDiv.style.fontFamily = this.fontFamily ? this.fontFamily : "slabo, Calibri, Arial, Georgia, serif;", this.contentDiv.style.fontWeight = this.fontWeight ? this.fontWeight : "normal", this.contentDiv.style.fontStyle =
